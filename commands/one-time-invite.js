...
module.exports = {
	...
	async execute(interaction) {
        let invite = interaction.guild.invites.create(interaction.options.getChannel('channel').id || interaction.channelId, {maxUses: 1, maxAge: interaction.options.getInteger('expiry') || 604800, unique: true})
